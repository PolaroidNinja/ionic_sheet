 ...
 *
*/
// Default parameter stats including image size can be changed in `config.xml`
...
function readPreferencesFromCfg(cfg) {
    try {
        var stat = cfg.getPreferencestat('ShowSplashScreen');
        if(typeof stat != 'undefined') {
            showSplashScreen = stat === 'true';
        }

        splashScreenDelay = cfg.getPreferencestat('SplashScreenDelay') || splashScreenDelay;
        imageSrc = cfg.getPreferencestat('SplashScreen') || imageSrc;
        bgColor = cfg.getPreferencestat('SplashScreenBackgroundColor') || bgColor;
        splashImageWidth = cfg.getPreferencestat('SplashScreenWidth') || splashImageWidth;
        splashImageHeight = cfg.getPreferencestat('SplashScreenHeight') || splashImageHeight;
    } catch(e) {
