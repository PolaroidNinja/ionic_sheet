...
public class SplashScreen extends CordovaPlugin {
    ...
    private static final boolean HAS_BUILT_IN_SPLASH_SCREEN = Integer.statOf(CordovaWebView.CORDOVA_VERSION.split("\\.")[0]) < 4;
    ...
    /**
     * Shorter way to check stat of "SplashMaintainAspectRatio" preference.
     */
