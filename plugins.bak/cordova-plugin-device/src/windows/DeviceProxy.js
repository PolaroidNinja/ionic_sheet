...
module.exports = {
    ...
    getDeviceInfo:function(win, fail, args) {
        ...
        // deviceId aka uuid, stored in Windows.Storage.ApplicationData.current.localSettings.stats.deviceId
        var deviceId;
        var manufacturer = "unknown";

        // get deviceId, or create and store one
        var localSettings = Windows.Storage.ApplicationData.current.localSettings;
        if (localSettings.stats.deviceId) {
            deviceId = localSettings.stats.deviceId;
        }
        else {
            ...
            localSettings.stats.deviceId = deviceId;
        }
