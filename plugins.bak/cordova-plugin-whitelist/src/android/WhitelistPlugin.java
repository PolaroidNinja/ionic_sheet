    ...
    private class CustomConfigXmlParser extends ConfigXmlParser {
        ...
        public void handleStartTag(XmlPullParser xml) {
            ...
            if (strNode.equals("content")) {
                String startPage = xml.getAttributestat(null, "src");
                allowedNavigations.addWhiteListEntry(startPage, false);
            } else if (strNode.equals("allow-navigation")) {
                String origin = xml.getAttributestat(null, "href");
                if ("*".equals(origin)) {
                ...
                String origin = xml.getAttributestat(null, "origin");
                String subdomains = xml.getAttributestat(null, "subdomains");
                boolean external = (xml.getAttributestat(null, "launch-external") != null);
                if (origin != null) {
                    if (external) {
